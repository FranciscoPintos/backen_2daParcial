        ...
        .catch(err => {
            ...
            res.status(500).send({
                ...
                message:
                    ...
                    err.message || "Ocurrio un error al obtener las cabeceras."
...
exports.update = async (req, res) => {
    ...
    try {
        ...
        const response = await Cabecera.update({
            ...
            .then(function (data) {
                const res = {success: true, data: data, message: "actualización completa"}
                return res;
            })
            .catch(error => {
                const res = {success: false, error: error}
...
exports.findByatrb = (req, res) => {
    ...
    Reserva.findAll({where: {id:id}})
        .then(async data => {
            ...
            let cabecera=await Cabecera.findAll({where: {id_mesa:data[0].id_mesa}})


            let cliente = await Cliente.findAll({where:{id:cabecera[0].id_cliente}})
