...
const FacturaComponent = ({
                              ...
                              detalles, setDetalles, id_reserva,
                          }) => {
    ...
    async function getDetalle() {
        if (cabecera[0]?.id) {
            ...
            const response= await axios.get(url + 'detalle/cabecera/' + cabecera[0]?.id);
    ...
    const handleDelete = (id) => {
        console.log(id);
        fetch(url +'detalle/id/' + id, {method: 'DELETE'})
            .then(res => res.text())
        window.location.reload(false);
    ...
    return (
        <div className="container">
            {!show &&
                <button onClick={handleMouseChange}>Mostrar</button>
            }
            {show &&
                ...
                <div className="col-16">
                    ...
                    <div className="panel invoice-list">
                        <div className="list-group animate__animated animate__fadeInLeft">
                                ...
                                <h5 className="mb-1">
                                    {!showForm && state &&
                                        <div>
                                            ...
                                            <button className="btn  btn-dark m-3" onClick={ClickClient}>Cambiar
                                                cliente
                                            </button>
                                        </div>
                                    ...
                                    {showForm &&
                                        <div className="col-5 m-1">
                                            <BootstrapTable bootstrap4 keyField='id' columns={columns} data={clientes}
                                                            filter={filterFactory()}/>
                                            <Link to="/cliente/add">
                                                <button className="btn btn-outline-danger">Crear Cliente</button>
                            ...
                            <strong className="amount mb-0">TOTAL: {detalles[0]?.suma} Gs.</strong>
                        </div>
                    </div>
                        ...
                        <div className="container mt-3">
                            <div className="card animate__animated animate__fadeIn">
                                <div className="card-header">
                                    ...
                                    <strong> </strong>
                                    <span className="float-right"> <strong>Estado:</strong> {cabecera[0]?.estado}
                                        {state &&
                                            <button className="btn btn-primary m-1" onClick={ChangeEstado}> Cerrar
                                                Mesa</button>
                                        }
                                    </span>
                                </div>
                                <div className="card-body">
                                    ...
                                    <div className="table-responsive-sm">
                                        <table className="table table-sm table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col" className="text-center d-none d-sm-table-cell"
                                                    width="50%">Descripción
                                                </th>

                                                <th scope="col" width="10%" className="text-right">Precio/Unidad</th>
                                                <th scope="col" width="8%" className="text-right">Cantidad</th>
                                                <th scope="col" width="10%" className="text-center">Total</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            {detalles.map((item, index) => {
                                                return (
                                                    ...
                                                    <tr key={item.id}>
                                                        ...
                                                        <th><button className="badge badge-danger" onClick={()=>handleDelete(item.id)}>Eliminar</button></th>
                                    ...
                                    {state &&
                                        <NewConsumo id_cabecera={cabecera[0]?.id}/>
                                    }
                                    <div className="row">
                                        <div className="col-lg-4 col-sm-5 ml-auto">
                                            <table className="table table-sm table-clear">
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="text-right bg-light">{detalles[0]?.suma} Gs</td>
                                                </tr>
            ...
            {showPDF &&
               <div>
                <div ref={ref}>
                   ...
                   <Pdf targetRef={ref} filename={"factura_" + cabecera[0].nombre + ".pdf"} options={options} scale={0.9}>
                       {({toPdf}) => <button className="btn btn-primary m-2" onClick={toPdf}>Generar
                           PDF</button>}
                   </Pdf>
                </div>
